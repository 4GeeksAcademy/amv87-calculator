	...
	return (
		<div className="container">
                <div className="calculator-base mt-5 rounded-3">
                    ...
                    <div className="keys-row1 mx-0 my-3 row d-flex justify-content-evenly text-center text-white">
                        <input type="button" value="C" className="key rounded-3 display-5" />
                        <div className="key rounded-3 display-5">+-</div>
                        <div className="key rounded-3 display-5">%</div>
                        <div className="key rounded-3 display-5">/</div>
                    </div>
                    <div className="keys-row2 mx-0 my-3 row d-flex justify-content-evenly text-center text-white">
                    ...
                    <div className="keys-row3 mx-0 my-3 row d-flex justify-content-evenly text-center text-white">
                    ...
                    <div className="keys-row4 mx-0 my-3 row d-flex justify-content-evenly text-center text-white">
                    ...
                    <div className="keys-row5 mx-0 my-3 row d-flex justify-content-evenly text-center text-white">
