		...
		<div className="container">
            <div className="row d-flex justify-content-center">
                <div className="calculator-base mt-5 rounded-3 d-flex">
                    ...
                    <div className="keys-row2 justify-content-evenly text-center text-white">
                    ...
                    <div className="keys-row4 justify-content-evenly text-center text-white">
                    ...
                    <div className="keys-row5justify-content-evenly text-center text-white">
